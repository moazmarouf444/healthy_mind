                ...
                <div class="col-12 p-0 ">
                    <div class="files_uploader_container  p-2" id="{{$inputName}}_cont">
                        @foreach ($input['files']['array'] as $file)
                            ...
                            @if( in_array(explode('.' ,$file[$input['files']['value']])[1] ,['jpg' ,'JPG' ,'png' ,'PNG' ,'jpeg' ,'JPEG' ,'SVG' ,'svg' ,'TIFF' ,'tiff' ,'webp' ,'WEBP']))
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input 
                                ...
                                name="{{$inputName}}[{{$lang}}]" 
                                class="form-control" placeholder="{{isset($input['placeholder']) ? $input['placeholder'][$lang] : awtTrans('قم بإدخال ') . ' ' . $input['text'][$lang]}}" 
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        ...
                        >
                            ...
                            @else
                                <option  disabled value>{{awtTrans('قم بإختيار ') . ' ' . $input['text']}}</option>
                            @endif
                    ...
                    <div>
                        <div class="form-group {{$input['map_address'] === null ? 'd-none' : ''}}">
                            ...
                            <div class="controls">
                                ...
                                placeholder="{{isset($input['placeholder']) ? $input['placeholder'] : awtTrans(' قم بإدخال العنوان ')}}" 
