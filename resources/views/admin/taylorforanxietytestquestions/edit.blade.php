        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{awtTrans('تعديل اسئله واجوبه مقياس تايلور للاختبار ')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.taylorforanxietytestquestions.update' , ['id' => $taylorforanxietytestquestion->id])}}" class="store form-horizontal" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    @foreach (languages() as $lang)
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text"
                                                           value="{{$taylorforanxietytestquestion->getTranslations('question')[$lang]}}"
                                    ...
                                    @foreach(languages() as $lang)
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text"
                                                           value="{{$taylorforanxietytestquestion->getTranslations('yes')[$lang]}}"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text"
                                                       value="{{$taylorforanxietytestquestion->value_yes}}"
                                        ...
                                        @foreach(languages() as $lang)
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text"
                                                               value="{{$taylorforanxietytestquestion->getTranslations('no')[$lang]}}"
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text"
                                                           value="{{$taylorforanxietytestquestion->value_no}}"
