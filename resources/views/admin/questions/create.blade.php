        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{awtTrans('اضافه اسئله واجابات للاختبار ')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.questions.store')}}" class="store form-horizontal" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <input hidden name="test_id" value="{{$test->id}}"></input>
                                    @foreach (languages() as $lang)
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">{{__('site.question_'.$lang)}}</label>
                                                <div class="controls">
                                                    <input type="text" name="question[{{$lang}}]"
                                                           class="form-control"
                                        ...
                                        @foreach (languages() as $lang)
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="answer_zero[{{$lang}}]"
                                                               class="form-control"
                                        ...
                                        @foreach (languages() as $lang)
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="answer_one[{{$lang}}]"
                                                               class="form-control"
                                        ...
                                        @foreach (languages() as $lang)
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="answer_two[{{$lang}}]"
                                                               class="form-control"
                                    ...
                                    @foreach (languages() as $lang)
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="answer_three[{{$lang}}]"
                                                           class="form-control"
                                    ...
                                    @endforeach
                                        ...
                                        <button type="submit" class="btn btn-primary mr-1 mb-1 submit_button">{{awtTrans('التالي')}}</button>
