            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{awtTrans('اضافه المساعده ')}}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{route('admin.helps.store')}}" class="store form-horizontal"
                                  novalidate>
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <textarea class="form-control" name="answer[{{$lang}}]"
                                                                  id="" cols="30" rows="10"
                                                                  placeholder="{{__('site.write') . __('site.answer_'.$lang)}}"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
