                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="gender" class="select2 form-control" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                                    <option value>{{awtTrans('اختر الجنس')}}</option>
