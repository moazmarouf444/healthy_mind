        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{awtTrans('تعديل مقياس توكيد الذات  ')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.selfassertiontests.update' , ['id' => $selfassertiontest->id])}}" class="store form-horizontal" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                    <div class="row">
                                        @foreach (languages() as $lang)
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text"
                                                               value="{{$selfassertiontest->getTranslations('name')[$lang]}}"
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <textarea class="form-control" name="biography[{{$lang}}]"
                                                                  id="" cols="30" rows="10"
                                                                  placeholder="{{__('site.write') . __('site.description_'.$lang)}}">{{$selfassertiontest->getTranslations('biography')[$lang]}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
