...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
{{--    addbutton="{{ route('admin.depressiontestquestions.create') }}" --}}
{{--    deletebutton="{{ route('admin.depressiontestquestions.deleteAll') }}" --}}
{{--    :searchArray="[--}}
{{--        'name' => [--}}
{{--            'input_type' => 'text' , --}}
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/depressiontestquestions')])
@endsection
