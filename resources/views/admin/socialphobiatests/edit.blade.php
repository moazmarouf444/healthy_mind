            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{awtTrans('تعديل مقياس ارهاب الاجتماعي ')}}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST"
                                  action="{{route('admin.socialphobiatests.update' , ['id' => $socialphobiatest->id])}}"
                                        ...
                                        @foreach (languages() as $lang)
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text"
                                                               value="{{$socialphobiatest->getTranslations('name')[$lang]}}"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <textarea class="form-control" name="biography[{{$lang}}]"
                                                                      id="" cols="30" rows="10"
                                                                      placeholder="{{__('site.write') . __('site.description_'.$lang)}}">{{$socialphobiatest->getTranslations('biography')[$lang]}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
